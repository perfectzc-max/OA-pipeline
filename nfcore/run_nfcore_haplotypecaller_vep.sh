...
###   -h	Help document.
###
### Path to this script: /Software/pipelines/nfcore/sarek/2.7/
...
ssh node07 -p 1103 "cd $outdir && export NXF_SINGULARITY_CACHEDIR=/Software/nf_core/singularity_imgs/sarek_v2.7 && /Software/nf_core/NEXTFLOW/nextflow run /Software/nf_core/nf-core-sarek-2.7/workflow/ \
--input $inputfile \
--tools HaplotypeCaller,VEP \
--genome $refs \
--igenomes_base /Software/Refs/references \
-profile singularity \
-c /Software/nf_core/slurm_config/slurm_submit.config \
